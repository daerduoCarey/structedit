...
def add_base_args(parser):
    ...
    parser.add_argument('--category', type=str, default=None, help='object category')
...
def add_model_args(parser):
    parser.add_argument('--ckpt_path', type=str, default='../data/models')
...
def add_data_args(parser):
    ...
    parser.add_argument('--self_is_neighbor', action='store_true', default=False)
...
def add_train_vae_args(parser):
    ...
    parser.add_argument('--resume_epoch', type=int, default=None, help='Resume training from this epoch (leave empty for starting a new training run)')
    ...
    parser.add_argument('--loss_weight_l1', type=float, default=0.0, help='weight for the l1 loss')
    ...
    parser.add_argument('--loss_weight_diffnode_type', type=float, default=1.0, help='loss weight')
    parser.add_argument('--loss_weight_diffnode_box', type=float, default=10.0, help='loss weight')
    ...
    # for shape-diff exps
    parser.add_argument('--shapediff_path', type=str, default='')
    parser.add_argument('--shapediff_topk', type=int, default=100, help='shapediff topk')
    parser.add_argument('--shapediff_metric', type=str, default='cd', help='shapediff metric')
...
def add_eval_args(parser):
    ...
    parser.add_argument('--shapediff_topk', type=int, default=20, help='shapediff topk')
